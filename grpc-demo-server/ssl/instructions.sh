...
openssl req -passin pass:1111 -new -x509 -days 365 -key ca.key -out ca.crt -subj "/CN=localhost" # "/CN=${SERVER_CN}"
...
openssl req -passin pass:1111 -new -key server.key -out server.csr -subj "/CN=localhost" # "/CN=${SERVER_CN}"
